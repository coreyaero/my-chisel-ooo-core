error id: file://<WORKSPACE>/src/main/scala/LSQ.scala:mycpu/Config.prfPtrWidth.
file://<WORKSPACE>/src/main/scala/LSQ.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol mycpu/Config.prfPtrWidth.
empty definition using fallback
non-local guesses:

offset: 1652
uri: file://<WORKSPACE>/src/main/scala/LSQ.scala
text:
```scala
package mycpu
...
class LSQ extends Module {
    val io = IO(new Bundle {
        ...
        val alloc_pdest = Input(UInt(Config.prfPtrWi@@dth.W))
