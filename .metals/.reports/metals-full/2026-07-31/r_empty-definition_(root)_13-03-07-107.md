error id: file://<WORKSPACE>/src/main/scala/Top.scala:dec1_br_tag
file://<WORKSPACE>/src/main/scala/Top.scala
empty definition using pc, found symbol in pc: dec1_br_tag
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/rename/io/dec1_br_tag.
	 -chisel3/rename/io/dec1_br_tag#
	 -chisel3/rename/io/dec1_br_tag().
	 -chisel3/util/rename/io/dec1_br_tag.
	 -chisel3/util/rename/io/dec1_br_tag#
	 -chisel3/util/rename/io/dec1_br_tag().
	 -rename/io/dec1_br_tag.
	 -rename/io/dec1_br_tag#
	 -rename/io/dec1_br_tag().
	 -scala/Predef.rename.io.dec1_br_tag.
	 -scala/Predef.rename.io.dec1_br_tag#
	 -scala/Predef.rename.io.dec1_br_tag().
offset: 10777
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
       ...
       // ★ 分配时必须同时看 LSQ 和所有模块是否有空位
        ...
        renamed_d1.branch_tag := rename.io.dec@@1_br_tag
