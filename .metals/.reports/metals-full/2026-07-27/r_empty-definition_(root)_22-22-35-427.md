error id: file://<WORKSPACE>/src/main/scala/AguUnit.scala:local4
file://<WORKSPACE>/src/main/scala/AguUnit.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/io/data_sram.
	 -chisel3/util/io/data_sram.
	 -io/data_sram.
	 -scala/Predef.io.data_sram.
offset: 10298
...
class AguUnit extends Module {
    val io = IO(new Bundle {
        ...
        val to_lsq = Decoupled(new Agu2Lsq())
    ...
    // 访存信号输出
    val is_mem = (ex2_data.resFromMem || ex2_data.memWe || ex2_data.is_cacop) && ex2_real_valid && !final_has_exc
    io.d@@ata_sram.req   := is_mem && !io.flush
