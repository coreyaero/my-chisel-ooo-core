error id: file://<WORKSPACE>/src/main/scala/Top.scala:flush_target_pc
file://<WORKSPACE>/src/main/scala/Top.scala
empty definition using pc, found symbol in pc: flush_target_pc
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/if_module/io/flush_target_pc.
	 -chisel3/if_module/io/flush_target_pc#
	 -chisel3/if_module/io/flush_target_pc().
	 -chisel3/util/if_module/io/flush_target_pc.
	 -chisel3/util/if_module/io/flush_target_pc#
	 -chisel3/util/if_module/io/flush_target_pc().
	 -if_module/io/flush_target_pc.
	 -if_module/io/flush_target_pc#
	 -if_module/io/flush_target_pc().
	 -scala/Predef.if_module.io.flush_target_pc.
	 -scala/Predef.if_module.io.flush_target_pc#
	 -scala/Predef.if_module.io.flush_target_pc().
offset: 3628
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        if_module.io.flu@@sh_target_pc := Mux(flush_global, rob.io.wb_target_pc, exec_engine.io.branch_pc)
        id_module.io.flush           := flush_frontend
        fetch_buf.io.flush := reset_high.asBool || flush_frontend
        disp_buf.io.flush := reset_high.asBool || flush_frontend
        ...
        // ---------------- TLB 连线 ----------------
        tlb_module.io.s0_vppn     := if_module.io.tlb_s0_vppn
        tlb_module.io.s0_va_bit12 := if_module.io.tlb_s0_va_bit12
        tlb_module.io.s0_asid     := if_module.io.tlb_s0_asid
        if_module.io.tlb_s0_found  := tlb_module.io.s0_found
        if_module.io.tlb_s0_ppn    := tlb_module.io.s0_ppn
        if_module.io.tlb_s0_ps     := tlb_module.io.s0_ps
        if_module.io.tlb_s0_plv    := tlb_module.io.s0_plv
        if_module.io.tlb_s0_mat    := tlb_module.io.s0_mat
        if_module.io.tlb_s0_v      := tlb_module.io.s0_v
        ...
        // ---------------- 访存 Cache 完美还原与仲裁 ----------------
        val if_req_valid = if_module.io.inst_sram.req
        ...
        icache.io.cpu.index  := Mux(actual_agu_req, q_addr(idx_bit, off_bit + 1), if_module.io.inst_sram.addr(idx_bit, off_bit + 1))
        icache.io.cpu.tag    := Mux(actual_agu_req, q_addr(tag_bit, idx_bit + 1), if_module.io.inst_sram.addr(tag_bit, idx_bit + 1))
        icache.io.cpu.offset := Mux(actual_agu_req, q_addr(off_bit, 0), if_module.io.inst_sram.addr(off_bit, 0))
        ...
        // 4. ★ 响应精准分发
        if_module.io.inst_sram.addr_ok := icache.io.cpu.addr_ok && can_issue_if
        if_module.io.inst_sram.data_ok := is_if_resp   // ★ 只吃属于 IF 的数据！
        if_module.io.inst_sram.rdata   := icache.io.cpu.rdata
