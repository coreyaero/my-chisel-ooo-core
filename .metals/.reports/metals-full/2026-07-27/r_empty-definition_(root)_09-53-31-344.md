error id: file://<WORKSPACE>/src/main/scala/Top.scala:lsq_alloc_lsOp
file://<WORKSPACE>/src/main/scala/Top.scala
empty definition using pc, found symbol in pc: lsq_alloc_lsOp
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/exec_engine/io/lsq_alloc_lsOp.
	 -chisel3/exec_engine/io/lsq_alloc_lsOp#
	 -chisel3/exec_engine/io/lsq_alloc_lsOp().
	 -chisel3/util/exec_engine/io/lsq_alloc_lsOp.
	 -chisel3/util/exec_engine/io/lsq_alloc_lsOp#
	 -chisel3/util/exec_engine/io/lsq_alloc_lsOp().
	 -exec_engine/io/lsq_alloc_lsOp.
	 -exec_engine/io/lsq_alloc_lsOp#
	 -exec_engine/io/lsq_alloc_lsOp().
	 -scala/Predef.exec_engine.io.lsq_alloc_lsOp.
	 -scala/Predef.exec_engine.io.lsq_alloc_lsOp#
	 -scala/Predef.exec_engine.io.lsq_alloc_lsOp().
offset: 9688
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        val dispatch_block = ctrl.io.wb_flush || ctrl.io.flush_id || is_mispredict || delayed_mispredict
        ...
        exec_engine.io.lsq_all@@oc_lsOp  := Mux(real_need_lsq0, d0.lsOp, d1.lsOp)
