error id: file://<WORKSPACE>/src/main/scala/Top.scala:rob_head
file://<WORKSPACE>/src/main/scala/Top.scala
empty definition using pc, found symbol in pc: rob_head
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/exec_engine/io/rob_head.
	 -chisel3/exec_engine/io/rob_head#
	 -chisel3/exec_engine/io/rob_head().
	 -chisel3/util/exec_engine/io/rob_head.
	 -chisel3/util/exec_engine/io/rob_head#
	 -chisel3/util/exec_engine/io/rob_head().
	 -exec_engine/io/rob_head.
	 -exec_engine/io/rob_head#
	 -exec_engine/io/rob_head().
	 -scala/Predef.exec_engine.io.rob_head.
	 -scala/Predef.exec_engine.io.rob_head#
	 -scala/Predef.exec_engine.io.rob_head().
offset: 15325
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
       ...
       // ★ 分配时必须同时看 LSQ 和所有模块是否有空位
        ...
        exec_engine.io.rob_h@@ead := rob.io.head_idx
