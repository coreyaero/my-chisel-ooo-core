error id: file://<WORKSPACE>/src/main/scala/Top.scala:cacop_en
file://<WORKSPACE>/src/main/scala/Top.scala
empty definition using pc, found symbol in pc: cacop_en
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/exec_engine/io/cacop_en.
	 -chisel3/exec_engine/io/cacop_en#
	 -chisel3/exec_engine/io/cacop_en().
	 -chisel3/util/exec_engine/io/cacop_en.
	 -chisel3/util/exec_engine/io/cacop_en#
	 -chisel3/util/exec_engine/io/cacop_en().
	 -exec_engine/io/cacop_en.
	 -exec_engine/io/cacop_en#
	 -exec_engine/io/cacop_en().
	 -scala/Predef.exec_engine.io.cacop_en.
	 -scala/Predef.exec_engine.io.cacop_en#
	 -scala/Predef.exec_engine.io.cacop_en().
offset: 24169
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
       ...
       // ★ 分配时必须同时看 LSQ 和所有模块是否有空位
        ...
        lsq_dcache_q.io.enq.bits.cacop_en := exec_engine.io.caco@@p_en && !exec_engine.io.cacop_is_icache
