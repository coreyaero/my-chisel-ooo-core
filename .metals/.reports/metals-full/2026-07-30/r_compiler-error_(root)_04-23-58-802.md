...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree
       tree position: line 852 of file://<WORKSPACE>/src/main/scala/Top.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
   ...
   850 
   851     // 深度为 2 的环形队列
   852     val q = Reg(Vec(2, new _CURSOR_LsqDcacheReq()))
   853     val head  = RegInit(0.U(1.W))
   854     val tail  = RegInit(0.U(1.W))
   855     val count = RegInit(0.U(2.W)) // 0, 1, 2
