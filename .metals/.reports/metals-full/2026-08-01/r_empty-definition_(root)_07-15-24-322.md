error id: file://<WORKSPACE>/src/main/scala/Interface.scala:mycpu/BtbEntry#valid.
file://<WORKSPACE>/src/main/scala/Interface.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol mycpu/BtbEntry#valid.
empty definition using fallback
non-local guesses:

offset: 4263
uri: file://<WORKSPACE>/src/main/scala/Interface.scala
text:
```scala
package mycpu
