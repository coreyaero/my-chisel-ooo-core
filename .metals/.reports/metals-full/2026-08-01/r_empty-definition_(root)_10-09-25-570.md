error id: file://<WORKSPACE>/src/main/scala/Exec.scala:mycpu/MduUnit#mdu_busy.
file://<WORKSPACE>/src/main/scala/Exec.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol mycpu/MduUnit#mdu_busy.
...
class MduUnit extends Module {
    ...
    val math_done = !valid_mdu_req || mdu_finished || (mdu_@@busy && Mux(is_div, div_done, mul_done))
