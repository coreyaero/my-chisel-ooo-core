error id: file://<WORKSPACE>/src/main/scala/Top.scala:axi
file://<WORKSPACE>/src/main/scala/Top.scala
empty definition using pc, found symbol in pc: axi
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/icache/io/axi.
	 -chisel3/icache/io/axi#
	 -chisel3/icache/io/axi().
	 -chisel3/util/icache/io/axi.
	 -chisel3/util/icache/io/axi#
	 -chisel3/util/icache/io/axi().
	 -icache/io/axi.
	 -icache/io/axi#
	 -icache/io/axi().
	 -scala/Predef.icache.io.axi.
	 -scala/Predef.icache.io.axi#
	 -scala/Predef.icache.io.axi().
offset: 22372
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        // ★ 修复 1：Ready(准备接收) 只能看优先级(can_issue_agu)和底层Cache是否就绪，绝不能包含 Valid！
