error id: file://<WORKSPACE>/src/main/scala/AguUnit.scala:chisel3/BitsIntf#apply(+1).
file://<WORKSPACE>/src/main/scala/AguUnit.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol chisel3/BitsIntf#
...
class AguUnit extends Module {
    ...
    val pa = Mux((ex2_data.crmd_da === 1.U) && (ex2_data.crmd_pg === 0.U), va,
            Mux(ex2_data.dmw_hit, ex2_data.dmw_pa, Mux(ex2_data.tlb_found && ex2_data.tlb_v, tlb_pa, va)))
    ...
    val ale = (ex2_data.resFromMem || ex2_data.memWe) && ex2_real_valid && 
              ((isWord && (ex2_va(1, 0) =/= 0.U)) || (isHalf && ex2_@@va(0) === 1.U))
