error id: file://<WORKSPACE>/src/main/scala/Top.scala:lsq_alloc
file://<WORKSPACE>/src/main/scala/Top.scala
empty definition using pc, found symbol in pc: lsq_alloc
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/exec_engine/io/lsq_alloc.
	 -chisel3/util/exec_engine/io/lsq_alloc.
	 -exec_engine/io/lsq_alloc.
	 -scala/Predef.exec_engine.io.lsq_alloc.
offset: 10021
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        renamed_d1.lsq_idx := exec_engine.io.l@@sq_alloc.idx
