error id: file://<WORKSPACE>/src/main/scala/AguUnit.scala:mycpu/AguUnit#raw_tlb_code.
file://<WORKSPACE>/src/main/scala/AguUnit.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/raw_tlb_code.
	 -chisel3/raw_tlb_code#
	 -chisel3/raw_tlb_code().
	 -chisel3/util/raw_tlb_code.
	 -chisel3/util/raw_tlb_code#
	 -chisel3/util/raw_tlb_code().
	 -raw_tlb_code.
	 -raw_tlb_code#
	 -raw_tlb_code().
	 -scala/Predef.raw_tlb_code.
	 -scala/Predef.raw_tlb_code#
	 -scala/Predef.raw_tlb_code().
offset: 8502
...
class AguUnit extends Module {
    ...
    val final_has_exc = ex2_d.hasException || ale || (early_is_mapped && raw_tlb@@_code =/= 0.U)
