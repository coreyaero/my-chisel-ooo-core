error id: file://<WORKSPACE>/src/main/scala/TLB.scala:local11
file://<WORKSPACE>/src/main/scala/TLB.scala
...
non-local guesses:
	 ...
	 -chisel3/io/s1_vppn#
	 -chisel3/io/s1_vppn().
	 -chisel3/util/io/s1_vppn.
	 -chisel3/util/io/s1_vppn#
	 -chisel3/util/io/s1_vppn().
	 -io/s1_vppn.
	 -io/s1_vppn#
	 -io/s1_vppn().
	 -scala/Predef.io.s1_vppn.
	 -scala/Predef.io.s1_vppn#
	 -scala/Predef.io.s1_vppn().
offset: 2990
uri: file://<WORKSPACE>/src/main/scala/TLB.scala
text:
```scala
package mycpu
...
class tlb extends Module {
    ...
    for (i <- 0 until 16) {
        val entry = tlb_table(i)
        val vppn_match = (io.s@@1_vppn(18, 9) === entry.vppn(18, 9)) &&  (entry.ps4MB || (io.s1_vppn(8, 0) === entry.vppn(8, 0)))
