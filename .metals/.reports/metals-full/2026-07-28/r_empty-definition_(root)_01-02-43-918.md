error id: file://<WORKSPACE>/src/main/scala/AguUnit.scala:mycpu/PipelineData#hasException.
file://<WORKSPACE>/src/main/scala/AguUnit.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol mycpu/PipelineData#hasException.
...
class AguUnit extends Module {
    ...
    out_data.ecode := Mux(ex2_data.hasExcepti@@on, ex2_data.ecode, final_ecode)
