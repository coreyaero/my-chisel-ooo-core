error id: file://<WORKSPACE>/src/main/scala/LSQ.scala:
file://<WORKSPACE>/src/main/scala/LSQ.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/io/agu_in_lsqIdx.
	 -chisel3/io/agu_in_lsqIdx#
	 -chisel3/io/agu_in_lsqIdx().
	 -chisel3/util/io/agu_in_lsqIdx.
	 -chisel3/util/io/agu_in_lsqIdx#
	 -chisel3/util/io/agu_in_lsqIdx().
	 -io/agu_in_lsqIdx.
	 -io/agu_in_lsqIdx#
	 -io/agu_in_lsqIdx().
	 -scala/Predef.io.agu_in_lsqIdx.
	 -scala/Predef.io.agu_in_lsqIdx#
	 -scala/Predef.io.agu_in_lsqIdx().
offset: 6473
...
class LSQ extends Module {
    ...
    when(io.agu_in.valid && entries(io.agu_in.bits.lsqIdx).valid) {
        val idx = io.agu_i@@n.bits.lsqIdx
