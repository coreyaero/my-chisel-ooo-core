error id: file://<WORKSPACE>/src/main/scala/ExecutionEngine.scala:
file://<WORKSPACE>/src/main/scala/ExecutionEngine.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/agu/io/to_lsq/valid.
	 -chisel3/agu/io/to_lsq/valid#
	 -chisel3/agu/io/to_lsq/valid().
	 -chisel3/util/agu/io/to_lsq/valid.
	 -chisel3/util/agu/io/to_lsq/valid#
	 -chisel3/util/agu/io/to_lsq/valid().
	 -agu/io/to_lsq/valid.
	 -agu/io/to_lsq/valid#
	 -agu/io/to_lsq/valid().
	 -scala/Predef.agu.io.to_lsq.valid.
	 -scala/Predef.agu.io.to_lsq.valid#
	 -scala/Predef.agu.io.to_lsq.valid().
offset: 8814
...
class ExecutionEngine extends Module {
    ...
    lsq.io.agu_in_valid   := agu.io.to_lsq.va@@lid && agu.io.out.ready
