error id: file://<WORKSPACE>/src/main/scala/Exec.scala:flush
file://<WORKSPACE>/src/main/scala/Exec.scala
empty definition using pc, found symbol in pc: flush
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/lsq/io/flush.
	 -chisel3/lsq/io/flush#
	 -chisel3/lsq/io/flush().
	 -chisel3/util/lsq/io/flush.
	 -chisel3/util/lsq/io/flush#
	 -chisel3/util/lsq/io/flush().
	 -lsq/io/flush.
	 -lsq/io/flush#
	 -lsq/io/flush().
	 -scala/Predef.lsq.io.flush.
	 -scala/Predef.lsq.io.flush#
	 -scala/Predef.lsq.io.flush().
offset: 4618
