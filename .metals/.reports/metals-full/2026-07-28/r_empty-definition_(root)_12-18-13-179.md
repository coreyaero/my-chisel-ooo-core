...
non-local guesses:
	 -chisel3/exec_engine/io/lsq_alloc_mask.
	 -chisel3/exec_engine/io/lsq_alloc_mask#
	 -chisel3/exec_engine/io/lsq_alloc_mask().
	 -chisel3/util/exec_engine/io/lsq_alloc_mask.
	 -chisel3/util/exec_engine/io/lsq_alloc_mask#
	 -chisel3/util/exec_engine/io/lsq_alloc_mask().
	 -exec_engine/io/lsq_alloc_mask.
	 -exec_engine/io/lsq_alloc_mask#
	 -exec_engine/io/lsq_alloc_mask().
	 -scala/Predef.exec_engine.io.lsq_alloc_mask.
	 -scala/Predef.exec_engine.io.lsq_alloc_mask#
	 -scala/Predef.exec_engine.io.lsq_alloc_mask().
offset: 9079
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
        ...
        exec_engine.io.lsq_@@alloc_mask  := Mux(real_need_lsq0, rename.io.dec0_br_mask, rename.io.dec1_br_mask) & current_br_clear
