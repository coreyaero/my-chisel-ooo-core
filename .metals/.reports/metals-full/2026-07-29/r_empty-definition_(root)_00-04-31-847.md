error id: file://<WORKSPACE>/src/main/scala/Top.scala:in_agu
file://<WORKSPACE>/src/main/scala/Top.scala
empty definition using pc, found symbol in pc: in_agu
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/exec_engine/io/in_agu.
	 -chisel3/util/exec_engine/io/in_agu.
	 -exec_engine/io/in_agu.
	 -scala/Predef.exec_engine.io.in_agu.
offset: 15077
...
class core_top extends RawModule {
    ...
    withClockAndReset(aclk, reset_high) {
       ...
       // ★ 分配时必须同时看 LSQ 和所有模块是否有空位
        ...
        iss_q_agu.io.deq.ready       := exec_engine.io.in_a@@gu.ready
